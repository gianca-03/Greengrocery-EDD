 ...
 * @author <GRC>
 */
public class InventarioFrutas extends javax.swing.JFrame {

    
    public InventarioFrutas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioFrutas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarioFrutas().setVisible(true);
            }
        });
    }
